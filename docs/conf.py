...
# -*- coding: utf-8 -*-
#
# Aloe Django documentation build configuration file, created by
...
htmlhelp_basename = 'AloeDjangodoc'
...
latex_documents = [
    (master_doc, 'AloeDjango.tex', 'Aloe Django Documentation',
     'Alexey Kotlyarov', 'manual'),
]
...
man_pages = [
    (master_doc, 'aloedjango', 'Aloe Django Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AloeDjango', 'Aloe Django Documentation',
     author, 'AloeDjango', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'aloe': ('http://aloe.readthedocs.org/en/latest/', None),
}
